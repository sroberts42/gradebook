...
public class ClassTest {
	...
	public void setUp() throws Exception {
		...
		newClass = new Class(course, "Fall", sections);
	...
	public void testAverages() {
		...
		assertEquals(82.5, newClass.averageScore(), 0);
	}
	...
	public void testLetterGrades() {
		...
		assertEquals('B', newClass.letterGrade());
	}
	
	@Test
	public void testGettersAndSetters() {
		assertEquals("Fall", newClass.getSemester());
		assertEquals(course, newClass.getCourse());
		assertTrue(newClass.setCourse(course));
		assertTrue(newClass.setSemester("Fall"));
	}
